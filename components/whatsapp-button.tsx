...
export function WhatsAppButton() {
  ...
  const openWhatsApp = () => {
    window.open('https://wa.me/5571988226503?text=Olá! Gostaria de saber mais sobre os serviços contábeis da Luz Contabilidade.', '_blank')
  }
  ...
  return (
    <div className={`fixed bottom-6 right-6 z-50 transition-all duration-500 ${isVisible ? 'translate-y-0 opacity-100' : 'translate-y-16 opacity-0'}`}>
      <button
        ...
        className="bg-whatsapp-500 hover:bg-whatsapp-600 text-white p-4 rounded-full shadow-2xl hover:shadow-3xl transition-all duration-300 group animate-pulse hover:animate-none"
